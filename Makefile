...
# test models: summary the resuts of models' performance
results/model_summary/random_forest_confusion_matrix.png results/model_summary/svc_confusion_matrix.png results/model_summary/test_f1_scores.csv results/model_summary/train_test_f1_scores.csv  results/model_summary/train_test_f1_scores.png : src/model_summary.py data/processed/credit_test_df.csv results/trained_models/dummy_classifier.joblib results/trained_models/knn.joblib results/trained_models/logistic_regression.joblib results/trained_models/random_forest.joblib results/trained_models/svc.joblib results/cross_validation_results.csv
...
# render final report
doc/credit_default_analysis_report.html : doc/credit_default_analysis_report.Rmd  results/model_summary/random_forest_confusion_matrix.png results/model_summary/svc_confusion_matrix.png results/model_summary/test_f1_scores.csv results/model_summary/train_test_f1_scores.png results/eda/images/target_proportion.jpg results/eda/images/corr_plot.png
