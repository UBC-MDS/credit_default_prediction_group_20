...
test_score_svc = final_test_results.loc['svc'].iloc[0]
test_score_rfc = final_test_results.loc['random_forest'].iloc[0]
test_score_knn = final_test_results.loc['knn'].iloc[0]
test_score_lr = final_test_results.loc['logistic_regression'].iloc[0]
