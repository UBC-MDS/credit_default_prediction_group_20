...
cv_result_table <- read_csv("../results/cross_validation_results.csv", skip = 1, col_names = c("Metric", "Dummy", "Random Forest Classifier", "Random Forest Classifier Optimized", "kNN", "kNN Optimized", "SCV", "SCV Optimized", "Logistic Regression ", "Logistic Regression Optimized"))
subset <- select(cv_result_table, "Metric", "Dummy", "Random Forest Classifier Optimized", "kNN Optimized", "SCV Optimized", "Logistic Regression Optimized")
