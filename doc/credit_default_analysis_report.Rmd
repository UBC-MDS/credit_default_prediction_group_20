...
```{r out.width = '75%', out.height = '75%', fig.align='center', fig.cap = "Figure 2. Pearson Correlation Graph highlighting the linear dependency between features."}
...
```{r out.width = '75%', out.height = '75%', fig.align='center', fig.cap = "Table 1. Cross Validation Results of the optimized Models."}
knitr::include_graphics("../results/cv_scores_table.png")
```
...
```{r out.width = '75%', out.height = '75%', fig.align='center', fig.cap = "Figure 4. Confusion matrix of `SVC`."}
knitr::include_graphics("../results/model_summary/svc_confusion_matrix.png")
```

```{r out.width = '75%', out.height = '75%', fig.align='center', fig.cap = "Figure 4. Confusion matrix of `RandomForestClassifier`."}
